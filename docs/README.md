...
We need expertise in handling `.es`, `.ani`, `.spr`, `.frm` and `.asd` files. If you have experience with these or can develop tools to manage these formats, please consider contributing.
